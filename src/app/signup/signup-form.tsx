        ...
        <Card className="w-full max-w-sm bg-black border-white/10 text-slate-100 shadow-2xl p-4">
            <CardHeader className="space-y-8 pt-6 pb-2">
                ...
                <div className="space-y-2">
                    <CardTitle className="text-2xl text-center font-bold text-white tracking-tight">Create account</CardTitle>
            ...
            <form onSubmit={handleSubmit}>
                <CardContent className="space-y-5">
                    <div className="space-y-2">
                        <Label htmlFor="name" className="text-xs font-medium text-gray-400 uppercase tracking-wider">Name</Label>
                        <Input
                            id="name"
                            name="name"
                            type="text"

        ...
        <div className="hidden md:flex justify-between items-center px-8 py-6 border-b border-white/10 shrink-0 bg-[#0c0c0c]">
            ...
            <div className="flex items-center gap-6">
                <div className="flex gap-3 text-xs font-bold tracking-wider">
                    <Link href="/dashboard" className="px-4 py-2 border border-white/20 rounded hover:bg-white/5 transition-colors flex items-center gap-2 text-white">
                    ...
                    <a href="mailto:gabriel@startg4.com" className="px-4 py-2 border border-white/20 rounded text-gray-400 hover:text-white hover:bg-white/5 transition-colors flex items-center gap-2">

...
export function CampaignDialog({ children, campaign, open: controlledOpen, onOpenChange }: CampaignDialogProps) {
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-[900px] bg-[#1a1a1a] text-white border-white/10">
                <DialogHeader>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 py-4">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid gap-2">
                            ...
                            <Select value={messageType} onValueChange={(val) => setMessageType(val as any)}>
                                ...
                                <SelectContent className="bg-[#1a1a1a] border-white/10 text-white">
                                    <SelectItem value="text" className="focus:bg-white/10">Apenas Texto</SelectItem>
                                    <SelectItem value="image" className="focus:bg-white/10">Imagem</SelectItem>
                                    <SelectItem value="video" className="focus:bg-white/10">Vídeo</SelectItem>
                                    <SelectItem value="audio" className="focus:bg-white/10">Áudio</SelectItem>
                                    <SelectItem value="document" className="focus:bg-white/10">Documento</SelectItem>
                                </SelectContent>
                            </Select>
                        </div>
                        ...
                        {messageType !== 'text' && (
                            <div className="grid gap-2">
                                ...
                                {mediaPreview && !mediaFile && (
                                    <p className="text-xs text-green-500 truncate">Mídia atual: ...{mediaPreview.slice(-15)}</p>
                                )}
                            </div>
                        )}
                        ...
                        <div className="grid gap-2">
                            ...
                            <Textarea
                                ...
                                className="h-[200px] resize-none bg-white/5 border-white/20 text-white"
                                value={message}
                    ...
                    <div className="flex justify-center items-center bg-black/20 rounded-lg p-4 border border-white/10">
                        {/* Phone Mockup */}

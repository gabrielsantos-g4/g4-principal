...
export function ContactsTable({ initialContacts }: ContactsTableProps) {
    return (
        <div className="border border-white/10 rounded-md bg-[#1a1a1a]">
            <Table>
                <TableHeader>
                    <TableRow className="border-white/10 hover:bg-white/5">
                        <TableHead className="text-gray-400">Nome</TableHead>
                        <TableHead className="text-gray-400">Telefone</TableHead>
                        <TableHead className="text-gray-400">Inscrito</TableHead>
                        <TableHead className="text-gray-400">Tags</TableHead>
                        <TableHead className="text-gray-400">Campanhas</TableHead>
                        <TableHead className="text-right text-gray-400">Data de Entrada</TableHead>
                    </TableRow>
                </TableHeader>
                <TableBody>
                                ...
                                <TableCell>
                                    <div className="flex gap-1 flex-wrap">
                                        {contact.tags?.map((tag, index) => (
                                            <Badge key={index} variant="secondary" className="text-xs bg-white/10 text-gray-300 hover:bg-white/20 border-0">
                                                {tag}
                                            </Badge>
                                        )) || '-'}
                                    </div>
